...
public final class AStartPathFind extends TraversalStrategyInterface {
        ...
        while (!verticesToVisit.isEmpty()) {
            ...
            if (currentVisitedVertex == destination) {
                ...
                while (adjacentVertex != null) {
                    ...
                    float currentDistance = getDistanceToVertex(currentVisitedVertexIndex)
                            + getTrueDistance((Room) currentVisitedVertex, (Room) adjacentVertex);
    ...
    private float getHeuristicDistance(Room source, Room destination) {
        return (float) distance(source.getPoint().getX(), source.getPoint().getY(), destination.getPoint().getX(),
                destination.getPoint().getY());
    }
